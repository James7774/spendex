    ...
    <>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div className="goal-card-header">
                  ...
                  {!isExpanded && (
                    <div className="goal-amount-compact">
                        <p className="amount-main" style={{ color: brandColor }}>
                          {formatCompactNumber(currentAmount)}
                        </p>
                        <p className="amount-target">
      ...
      <style jsx>{`
        ...
        @media (max-width: 380px) {
            ...
            .goal-amount-compact {
               /* If it wraps, we want it to align properly */
               margin-left: auto;
            }
            
            .goal-title { font-size: 1rem; }
            .amount-main { font-size: 0.9rem; }
            .goal-percentage { font-size: 0.75rem; padding: 2px 6px; }
        }
      `}</style>
    </>
  );

...
export default function DashboardPage() {
  ...
  return (
    <div className={styles.dashboardContent} style={{ 
      display: 'flex', 
      ...
      {/* Fixed Top Container: Header + Action Buttons + Recent Transactions Title */}
      <div style={{ flexShrink: 0, width: '100%', background: 'var(--background)', zIndex: 10 }}>
        ...
        {/* Recent Transactions Title Row - Fixed */}
        <div style={{ marginBottom: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 16px 4px' }}>
